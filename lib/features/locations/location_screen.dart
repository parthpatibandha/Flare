...
class LocationScreenState extends State<LocationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBarWidget(
          message: StringConstants.screenLocation,
          actionList: [
            _createActions()
          ],
      ),
            ...
            return Card(
              child: ListTile(
                ...
                title: Text(
                  ...
                  style: const TextStyle(color: Colors.white, fontSize: Styles.fontSizeH6),
                ),
              ),
            );
          }
  ...
  void _toggleListening() {
    if (_positionStreamSubscription == null) {
      ...
      final positionStream =
          _geolocatorPlatform.getPositionStream(locationSettings: locationSettings);
